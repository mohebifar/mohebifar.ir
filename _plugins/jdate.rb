...
class JalaliDate
  ...
  PERSIAN_MONTH_NAMES = [nil, "farvar","farvar","farvar","farvar","farvar","farvar","مهر","آبان","آذر","دی","بهمن","اسفند"]
...
module Jekyll
  module AssetFilter
    def jdate(input, pattern="%Y %m %d")
      JalaliDate.new(input).strftime(pattern)
    end
  end
end
